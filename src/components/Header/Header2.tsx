            ...
            <div className="header2__profile">
                <a href="#" className="header2__profile_item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                        <path d="M17.1666 15.8333V17.5H3.83325V15.8333C3.83325 14.9493 4.18444 14.1014 4.80956 13.4763C5.43468 12.8512 6.28253 12.5 7.16659 12.5H13.8333C14.7173 12.5 15.5652 12.8512 16.1903 13.4763C16.8154 14.1014 17.1666 14.9493 17.1666 15.8333Z" stroke="#282828" stroke-width="1.43015" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M10.5 9.16667C12.3409 9.16667 13.8333 7.67428 13.8333 5.83333C13.8333 3.99238 12.3409 2.5 10.5 2.5C8.65901 2.5 7.16663 3.99238 7.16663 5.83333C7.16663 7.67428 8.65901 9.16667 10.5 9.16667Z" stroke="#282828" stroke-width="1.43015" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Войти
                </a>
                <a href="#" className="header2__profile_item">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path d="M7.49996 18.3333C7.9602 18.3333 8.33329 17.9602 8.33329 17.5C8.33329 17.0397 7.9602 16.6666 7.49996 16.6666C7.03972 16.6666 6.66663 17.0397 6.66663 17.5C6.66663 17.9602 7.03972 18.3333 7.49996 18.3333Z" stroke="#525252" stroke-width="1.66" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M16.6666 18.3333C17.1268 18.3333 17.4999 17.9602 17.4999 17.5C17.4999 17.0397 17.1268 16.6666 16.6666 16.6666C16.2063 16.6666 15.8333 17.0397 15.8333 17.5C15.8333 17.9602 16.2063 18.3333 16.6666 18.3333Z" fill="#525252" stroke="#525252" stroke-width="1.66" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M0.833374 0.833313H4.16671L6.40004 11.9916C6.47624 12.3753 6.68496 12.7199 6.98966 12.9652C7.29436 13.2105 7.67562 13.3408 8.06671 13.3333H16.1667C16.5578 13.3408 16.9391 13.2105 17.2438 12.9652C17.5484 12.7199 17.7572 12.3753 17.8334 11.9916L19.1667 4.99998H5.00004" stroke="#525252" stroke-width="1.66" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                    Корзина
                </a>
            </div>
